          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                            ...
                            child: CircleAvatar(
                              radius: 50.0,
                              backgroundImage: (member.member.avatar != null &&
              ...
              Container(
                ...
                padding:
                    EdgeInsets.only(left: 20, right: 20, bottom: 20.0, top: 20),
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(20),
                  color: Colors.white,
                  boxShadow: [
                ...
                child: Column(
                  children: List.generate(
                      images.length, (index) => _renderProfile(index, member)),
                ),
              ),
              Container(
                padding: EdgeInsets.all(20),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.of(context)
                              .pushNamed(EDIT_PROFILE_PAGE_ROUTE);
                        },
