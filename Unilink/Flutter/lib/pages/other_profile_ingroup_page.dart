...
class OtherProfileIngroupPage extends StatefulWidget {
  @override
  _OtherProfileIngroupPageState createState() =>
      _OtherProfileIngroupPageState();
}

class _OtherProfileIngroupPageState extends State<OtherProfileIngroupPage> {
  ...
  Future<MemberViewModel> getInforMember() async {
    MemberViewModel member = await Provider.of<MemberListViewModel>(context,
            listen: false)
        .getInforMember(
